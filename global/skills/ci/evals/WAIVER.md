...
This waiver covers a real CI/gate state change across arbitrary repos.
No single fixture repo captures the space.
Build a small seeded suite of intentionally-broken CI configs before an A/B run can produce a useful result.
...
When it expires, add an eval spec at `global/skills/ci/evals/ci-eval.md`.
