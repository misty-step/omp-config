...
`audit-simplifications`, `brief`, `code-review`, `deliver`, `diagnose`,
`explore-unknowns`, `foundation`, `improve-codebase-architecture`,
`install-anti-slop`, `prototype`, `security-review`, `tidy`.
