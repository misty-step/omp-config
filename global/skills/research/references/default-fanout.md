...
| Model pricing or availability | dated web sources via Exa + official pages | global/skills/harness-engineering/references/model-provider-harness-index.md, then verify live |
