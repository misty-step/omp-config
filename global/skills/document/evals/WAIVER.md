# /document eval waiver

expires: 2026-09-29

## Reason

Multi-agent survey+write+verify loop is expensive per run; a real fixture run is a budget commitment tracked for a future pass, not yet scheduled.
...
at `global/skills/document/evals/document-eval.md` (see `global/skills/skill-eval/templates/eval-spec.md`)
