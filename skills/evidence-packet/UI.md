...
change. Give it the inspected artifact and the surface to look at, never the
intended change, the fix, or the conversation. The implementer's eyes are
primed by the fix; fresh eyes catch what they pass.
