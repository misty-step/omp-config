...
Requires a live, authenticated Todoist workspace to exercise for real; an external account dependency, not yet wired into a repeatable fixture.
...
at `global/skills/todoist/evals/todoist-eval.md` (see `global/skills/skill-eval/templates/eval-spec.md`)
