...
Use only credentials from the target project's declared Misty Step credential
map. Never search or read another organization's credential sources. Transfer
named values through protected files, standard input, or environment variables
