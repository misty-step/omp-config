...
- Structural skill creation or rewrites: read `global/skills/writing-for-agents/SKILL.md` and its disclosed `SKILL-MECHANICS.md` (`mattpocock-writing-for-agents`).
