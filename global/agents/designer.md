...
model: kimi-code/k3:max, anthropic/claude-fable-5:xhigh, openai-codex/gpt-5.6-luna:xhigh, openai-codex/gpt-5.6-sol:xhigh, google-antigravity/gemini-3.6-flash:high, xai-oauth/grok-4.5:high, anthropic/claude-opus-5:xhigh, openrouter/deepseek/deepseek-v4-flash-0731:high, openrouter/openai/gpt-5.6-luna:xhigh, openrouter/x-ai/grok-4.5:high, openrouter/z-ai/glm-5.2:high
thinkingLevel: max
