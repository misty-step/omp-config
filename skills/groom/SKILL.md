---
name: groom
description: Reconcile a named backlog decision with product direction and current evidence.
...
Groom the operator's named scope. Do not turn a focused decision into a full
portfolio audit.
