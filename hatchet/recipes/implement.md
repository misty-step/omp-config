...
6. Return exactly one terminal JSON object: `{"version":1,"outcome":"completed","headSha":"<new full HEAD>","artifactRefs":["commit:<sha>","gate:<exact command> => <result>","files:<list>"]}`. No prose or second JSON object.
